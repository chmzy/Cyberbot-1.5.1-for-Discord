...
class Essential(commands.Cog):
    ...
    async def helpme(self, ctx):
        ...
        embed_help.add_field(name='`=levak @упоминание`', value='Проводит тест левачество', inline=False)
        embed_help.add_field(name='`=pdr @упоминание`', value='Проводит тест на пидора', inline=False)
